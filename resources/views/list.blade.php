...
<div class="login-container">
    ...
    <form action="" method="POST">
        ...
        <div class="button-container">
            <button type="button" class="register-btn" onclick="location.href='http://localhost:80/practice2/public/regist'">新規登録</button>
            <button type="submit" class="login-btn" onclick="location.href='http://localhost:80/practice2/public/productinfo'">ログイン</button>
        </div>
    </form>
</div>
